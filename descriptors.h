...
#define _DESCRIPTORS_H_
	...
	/* Macros: */
		...
		#define AUDIO_STREAM_EPADDR           (ENDPOINT_DIR_IN | 1) 
 		#define AUDIO_STREAM_EPADDR_1           (ENDPOINT_DIR_IN | 3)
		...
		// #define AUDIO_STREAM_EPSIZE           256
 		...
 		#define AUDIO_STREAM_EPSIZE_1           64

 	//2 Channels and EPSIZE 192 
	...
	/* Type Defines: */
		...
		typedef struct
		{
			...
			// Audio Control Interface
			USB_Descriptor_Interface_t                Audio_ControlInterface1;
			USB_Audio_Descriptor_Interface_AC_t       Audio_ControlInterface_SPC1;
			USB_Audio_Descriptor_InputTerminal_t      Audio_InputTerminal1;
			USB_Audio_Descriptor_OutputTerminal_t     Audio_OutputTerminal1;

			// Audio Streaming Interface
			USB_Descriptor_Interface_t                Audio_StreamInterface_Alt01;
			USB_Descriptor_Interface_t                Audio_StreamInterface_Alt11;
			USB_Audio_Descriptor_Interface_AS_t       Audio_StreamInterface_SPC1;
			USB_Audio_Descriptor_Format_t             Audio_AudioFormat1;
			USB_Audio_SampleFreq_t                    Audio_AudioFormatSampleRates1[1];
			USB_Audio_Descriptor_StreamEndpoint_Std_t Audio_StreamEndpoint1;
			USB_Audio_Descriptor_StreamEndpoint_Spc_t Audio_StreamEndpoint_SPC1;
