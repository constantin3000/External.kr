A basic 8 channel sound card (8kHz 16bit) running on a atmega32u4 controller. A mcp3208 is being used as ADC. The USB device implements a card with two devices each having 4 streams. 
```
32u4		MCP3208
PB0 CS	 	10	
PB1 CLK  	13
